<%@ Page Title="Edit Personal Details" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditPersonalDetail.aspx.cs" Inherits="PicUploadWpfApplication.UserPages.EditPersonalDetail" %>
                ...
                <td align="center">
                    <table class="tableBackground" width="100%">
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>
                                <asp:TextBox ID="txtUserName" runat="server" Width="160px" Enabled="false"></asp:TextBox>
                       ...
                       <tr>
                        ...
                        <tr>
                            <td colspan='2' align="center">
                                <asp:Button ID="btnUpdateDetails" runat="server" 
                                    Text="<%$ Resources:FormFillUpResource,UpdateDetails %>" Width="150px" 
